...
<body class="font-sans antialiased">
  ...
  ```
-->
    <div class="relative h-screen flex overflow-y-hidden bg-white" x-data="{mobileside:false}">
        <!-- Off-canvas menu for mobile, show/hide based on off-canvas menu state. -->
        <div x-cloak x-show="mobileside" class="fixed inset-0 flex z-40 lg:hidden" role="dialog" aria-modal="true">
            <!--
    ...
    -->
      ...
      Leaving: "transition ease-in-out duration-300 transform"
        ...
        To: "-translate-x-full"
    -->
            <div class="relative flex-1 flex flex-col max-w-xs w-full  pb-4 bg-side">
                <!--
      ...
      -->
                <div class="absolute top-0 right-0 -mr-12 pt-2">
                    <button @click="mobileside = !mobileside" type="button"
                ...
                <div class="flex-shrink-0 flex items-center justify-center bg-white py-2">
                    <img class="h-12 w-auto" src="{{ asset('images/HR.jpg') }}" alt="Workflow">
                </div>
        ...
        <div class="flex flex-col w-0 flex-1 overflow-hidden">
            ...
            <div class="relative z-10 flex-shrink-0 flex h-16 bg-white border-b border-gray-200 lg:hidden">
                ...
                <div class="flex-1 flex justify-between px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center" x-data="{mobiledrop:false}">
                        <!-- Profile dropdown -->
                        <div class="ml-3 relative">
                            <div>
                                <button @click="mobiledrop = !mobiledrop" type="button"
            ...
            <main class="flex-1 relative z-0 overflow-y-hidden focus:outline-none">
                <!-- Page title & actions -->
                @include('layouts.fixelements.navbar')

                <div class="flex-1 flex items-stretch overflow-y-hidden">
                    @yield('main')
